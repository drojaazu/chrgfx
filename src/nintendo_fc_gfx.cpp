...
// NESticle palette
const palette nintendo_fc_px::std_fc_pal = palette {
		color(0x5B,0x5B,0x5B),
		color(0x00,0x00,0xB4),
		color(0x00,0x00,0xA0),
		color(0x3D,0x00,0xB1),
		color(0x69,0x00,0x74),
		color(0x5B,0x00,0x00),
		color(0x5F,0x00,0x00),
		color(0x41,0x18,0x00),
		color(0x10,0x2F,0x00),
		color(0x08,0x4A,0x08),
		color(0x00,0x67,0x00),
		color(0x00,0x42,0x12),
		color(0x00,0x28,0x6D),
		color(0x00,0x00,0x00),
		color(0x00,0x00,0x00),
		color(0x00,0x00,0x00),
		color(0xE7,0xD5,0xC4),
		color(0x00,0x40,0xFF),
		color(0x22,0x0E,0xDC),
		color(0x6B,0x47,0xFF),
		color(0x9F,0x00,0xD7),
		color(0xD7,0x0A,0x68),
		color(0xBC,0x19,0x00),
		color(0xB1,0x54,0x00),
		color(0x5B,0x6A,0x00),
		color(0x03,0x8C,0x00),
		color(0x00,0xAB,0x00),
		color(0x00,0x88,0x2C),
		color(0x00,0x72,0xA4),
		color(0x00,0x00,0x00),
		color(0x00,0x00,0x00),
		color(0x00,0x00,0x00),
		color(0xF8,0xF8,0xF8),
		color(0x3C,0xAB,0xFF),
		color(0x81,0x79,0xFF),
		color(0xC5,0x5B,0xFF),
		color(0xF2,0x48,0xFF),
		color(0xFF,0x49,0xDF),
		color(0xFF,0x6D,0x47),
		color(0xF7,0x8C,0x00),
		color(0xFF,0xE0,0x00),
		color(0x75,0xE3,0x00),
		color(0x2B,0xF4,0x03),
		color(0x2E,0xB8,0x78),
		color(0x18,0xE2,0xE5),
		color(0x78,0x78,0x78),
		color(0x00,0x00,0x00),
		color(0x00,0x00,0x00),
		color(0xFF,0xFF,0xFF),
		color(0xBE,0xF2,0xFF),
		color(0xB8,0xB8,0xF8),
		color(0xD8,0xB8,0xF8),
		color(0xFF,0xB6,0xFF),
		color(0xFF,0xC3,0xFF),
		color(0xFF,0xD1,0xC7),
		color(0xFF,0xDA,0x9A),
		color(0xF8,0xED,0x88),
		color(0xDD,0xFF,0x83),
		color(0xB8,0xF8,0xB8),
		color(0xAC,0xF8,0xF5),
		color(0xB0,0xFF,0xFF),
		color(0xF8,0xD8,0xF8),
		color(0x00,0x00,0x00),
		color(0x00,0x00,0x00)
};
