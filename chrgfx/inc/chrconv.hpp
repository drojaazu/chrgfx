 ...
 */
byte_t * encode_chr(chrdef const & chrdef, pixel_t const * tile, byte_t * out = nullptr);
 ...
 */
pixel_t * decode_chr(chrdef const & chrdef, byte_t const * tile, byte_t * out = nullptr);
